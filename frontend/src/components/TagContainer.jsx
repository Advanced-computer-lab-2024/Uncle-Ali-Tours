...
function TagContainer({tagName, tagChanger}) {
  ...
  return (
    <div className='flex justify-between mb-6 text-black text-left w-[20vw] bg-white mx-auto rou h-[5vh] rounded'>
        ...
        <div className='flex'>
        <button onClick={() => (handleUpdateClick())} className='mr-4' ><MdOutlineDriveFileRenameOutline size='18' color='black' /></button>
        <button onClick={() => (handleClick())} className='mr-2'><MdDelete size='18' color='black' /></button>
